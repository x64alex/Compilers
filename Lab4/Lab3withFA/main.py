import st
from fa import read_fa_from_file 
...
def scanner(programFile, tokenFile):
    ...
    intFA = read_fa_from_file("int.in")
    identifierFA = read_fa_from_file("identifier.in")
